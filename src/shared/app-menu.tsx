    ...
    <Box sx={{flexGrow: 1}}>
      <AppBar position="static">
        <Toolbar>
          ...
          <TemplateMenu name={"Products"}></TemplateMenu>
          <TemplateMenu name={"Community"}></TemplateMenu>
          <TemplateMenu name={"Markets"}></TemplateMenu>
          <TemplateMenu name={"Brokers"}></TemplateMenu>
